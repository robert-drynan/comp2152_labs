...
while not input_valid and i in range(5):
    try:
        ...
        print("Exception: Invalid input Enter a valid integer - player")
...
while not m_input_valid and i in range(5):
    try:
        ...
        print("Exception: Invalid input Enter a valid integer - monster")
...
while m_health_points > 0 and health_points > 0:
    ...
    if not (attack_roll % 2 == 0):
        ...
        try:
            ...
            print("Exception: Invalid input Enter a valid integer combat_strength and m_helth_points")
